    ...
    return (
        <div className="pt-24">
            ...
            <div className="flex justify-center -mt-14 sm:-mt-24 md:-mt-30 lg:-mt-36">
                <Image src={banner4} alt="img_banner" className=" pl-4 flex items-center pr-4 sm:w-12/12 md:w-11/12 lg:w-11/12 xl:max-w-screen-xl 2xl:max-w-screen-xl 2xl:mx-auto" />
            </div>
        </div>
